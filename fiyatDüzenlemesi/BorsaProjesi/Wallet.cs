...
namespace BorsaProjesi
{
    public partial class Wallet : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToString(cmbDovizTipi.SelectedItem) =="ABD DOLARI")
            {
                decimal doviz = Convert.ToDecimal(dataGridView1.Rows[0].Cells[2].Value.ToString());
                eklenecekBakiye = Convert.ToDecimal(txtPara.Text) * dolar;
            ...
            if (Convert.ToString(cmbDovizTipi.SelectedItem) == "EURO")
            {
                decimal doviz = Convert.ToDecimal(dataGridView1.Rows[0].Cells[2].Value.ToString());
                eklenecekBakiye = Convert.ToDecimal(txtPara.Text) * dolar;
                MessageBox.Show("Test: " + eklenecekBakiye);
