...
namespace BorsaProjesi
{
    public partial class AddProduct : Form
    {
        ...
        private void btnUrunEkle_Click(object sender, EventArgs e)
        {
            ...
            komutUrunEkle.Parameters.AddWithValue("@p4", Convert.ToString(txtUrunFiyati.Text));
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            products[Convert.ToInt32(urunIndex) - 1].UrunFiyati =Convert.ToDecimal( txtGuncelUrunFiyati.Text);
            ...
            SqlCommand urunGuncelle = new SqlCommand("Update Urunler set UrunBirimi=@p1,UrunFiyati=@p2,UrunOnay=@p3,EskiUrunFiyati=@p4,EskiUrunBirimi=@p5 where UrunId=@p6", sqlConnect.Connection());
           
            urunGuncelle.Parameters.AddWithValue("@p1", txtGuncelUrunBirimi.Text);
            urunGuncelle.Parameters.AddWithValue("@p2", Convert.ToString(txtGuncelUrunFiyati.Text));
            urunGuncelle.Parameters.AddWithValue("@p3", false);
            urunGuncelle.Parameters.AddWithValue("@p4", Convert.ToString(products[Convert.ToInt32(urunIndex) - 1].EskiUrunFiyati));
            urunGuncelle.Parameters.AddWithValue("@p5", products[Convert.ToInt32(urunIndex) - 1].EskiUrunBirimi);
            urunGuncelle.Parameters.AddWithValue("@p6", products[Convert.ToInt32(urunIndex) - 1].UrunId);
