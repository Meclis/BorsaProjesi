...
namespace WindowsFormsApp3
{
    public partial class RegisterPanel : Form
    {
        ...
        private void btnKayit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand kayit = new SqlCommand("insert into KullaniciBilgileri (Ad,Soyad,KullaniciAdi,Sifre,KullaniciTcNo,KullaniciMail,Adres,Telefon,GuncelBakiye,YeniBakiye) values (@p1,@p2,@p3,@p4,@p5,@p6,@p7,@p8,@p9,@p10)", sqlConnect.Connection());
