...
namespace BorsaProjesi
{
    public partial class AcceptWallet : Form
    {
        ...
        private void btnOnayla_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand bakiyeOnayla = new SqlCommand("Update KullaniciBilgileri SET GuncelBakiye=@p1,YeniBakiye=@p2,ParaBirimi=@p3 where ıd=@p4", sqlConnect.Connection());
            bakiyeOnayla.Parameters.AddWithValue("@p1",Convert.ToString(Convert.ToDecimal(dataGridView1.Rows[secilen].Cells[9].Value.ToString()) + eklenecekBakiye));
            bakiyeOnayla.Parameters.AddWithValue("@p2", 0);
            bakiyeOnayla.Parameters.AddWithValue("@p3", "TÜRK LİRASI");
            bakiyeOnayla.Parameters.AddWithValue("@p4", dataGridView1.Rows[secilen].Cells[0].Value.ToString());
